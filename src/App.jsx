  ...
  return (
    <div className="App">
      ...
      <main className="fade-in">
        <Routes>
          <Route path="/" element={currentUser ? (isAdmin ? <Navigate to="/admin" /> : <Navigate to="/warga" />) : <LandingPage />} />
          ...
          <Route path="/tukar-poin" element={currentUser ? <RedeemPoints /> : <Navigate to="/login" />} />
